...
(function(w) {
    ...
    try {
        var links = ["https:\/\/s.ad.smaato.net\/c\/?dspInit=1001376\u0026dspCookie=2818f8634032301ff96ba9e2e2c6534a","https:\/\/sync.taboola.com\/sg\/widerplanetkorea-network\/1\/rtb-h\/?taboola_hm=2818f8634032301ff96ba9e2e2c6534a","https:\/\/sbm.nate.com\/setCookie?venderKey=wider\u0026userKey=2818f8634032301ff96ba9e2e2c6534a"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-2818f8634032301ff96ba9e2e2c6534a-s1653458833.709000|windows_10|chrome-14o530f", 365);
                return;
            }
        }
...
(function(w) {
    try {
        ...
        identity.setCookie("_molecule_id", "2818f8634032301ff96ba9e2e2c6534a", 365);
